    ...
    return (
        <div className="w-1/3 p-8 flex flex-col items-end">
            <div className="flex flex-col gap-12">
                <h1 className="caprasimo-font text-xl text-blue-700 text-shadow-2xs text-shadow-black">Logo</h1>
                <div className="flex flex-col">

                    <Link to="/"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none">
